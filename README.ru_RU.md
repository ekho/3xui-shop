...
| AUDIT_RETENTION_DAYS | ⭕ | 365 | Сколько дней хранить события аудит-лога; суточный джоб чистит старше и пишет об этом системное событие. Зеркало метаданных постит support-бот в топик General группы SUPPORT_GROUP_ID; тела сообщений остаются в БД — см. DEPLOYMENT.md §5c |
| | | |
